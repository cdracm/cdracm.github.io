...
![](comments_correct.png)

But sometimes, they say, this horror happens. Which is incorrect, because some other colors leaked inside the comments :
![](comments_incorrect.png)

For some time I believed the reasons were obvious but not actionable. All programmers know their first lines of defence:
- (most used) CMB radiation from the Big Bang flipped a couple of memory transistors
- The previous OutOfMemoryError corrupted some internal state
- The JDK is too old, or too new, depending.

Unfortunately, one evening I did witness this bug myself, which meant it was real, and I had to skip to the fifth acceptance stage immediately.
I had to fix it.
...
__Last__, I still needed a coffee and a day to decipher what happened, but it boiled down to this.
